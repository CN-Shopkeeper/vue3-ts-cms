<template>
  <div class="overview">
    <sk-card title="关于">
      <div class="c-left">
        Vue3Admin 是基于 Vue3、Vuex、VueRouter、Vue CLI、 ElementPlus
        、TypeScript、Echart5 等后台系统解决方案。
        该系统是Shopkeeper学习VUE3-TypeScript时，构建的项目。
      </div>
    </sk-card>
    <sk-card title="技术栈">
      <sk-text-link :text-arrs="technologyStacks" />
      <sk-descriptions
        title="生产环境依赖"
        :column="2"
    ...
    <sk-card title="项目结构">
      <div class="c-left">
        <sk-code language="bash" :code="projectDir" />
      </div>
    </sk-card>
    <sk-card title="项目规范">
      <sk-descriptions
...
import SkDescriptions from "@/base-ui/descriptions";
import SkTextLink from "@/base-ui/text-link";
import SkCode from "@/base-ui/code";
